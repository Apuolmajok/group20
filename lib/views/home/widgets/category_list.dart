        ...
        children: List.generate(categories.length, (i) {
          ...
          return GestureDetector( 
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: controller.categoryValue == category['_id'] ? kPrimary : kOffWhite, width: .5.w)
            ),
            ...
            child: Column(
              children: [
                ...
                ReusableText(text: category["title"], style: appStyle(12, kSecondary, FontWeight.bold))
              ],
            ),
